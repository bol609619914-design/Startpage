...
<template>
  <base-dialog v-model="opened" acrylic opacity container-class="about__dialog noselect">
    <section>
      <div class="ext-icon">
        <a href="https://start.abobb.site" target="_blank">
      ...
      <div class="copyright">
        ©&nbsp;{{ year }}&nbsp;
        <el-link underline="never" href="https://start.abobb.site"> Startpage </el-link>
      </div>
      <el-space class="ext-links" :size="12">
        <el-link
          underline="never"
          target="_blank"
          href="https://github.com/bol609619914-design/Startpage/"
        >
