...
function handleEmailClick() {
  navigator.clipboard.writeText('abo_bb@qq.com')
  ...
  <base-dialog v-model="opened" :title="t('newtab:menu.help')" acrylic opacity>
    <div class="issue-container noselect">
      ...
      <div class="issue-links">
        <a
          class="issue-link"
          href="https://github.com/bol609619914-design/Startpage/issues/new"
          target="_blank"
        >
      ...
      <div class="faq-item">
        ...
        <div class="markdown-body">
          ...
          <p>
            ...
            <a href="https://github.com/bol609619914-design/Startpage/issues" target="_blank">
